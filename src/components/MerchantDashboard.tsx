...
export function MerchantDashboardSkeleton() {
  return (
    <div className="w-full min-h-screen bg-[#F8FAFC] dark:bg-slate-950 p-4 sm:p-6 space-y-6 animate-pulse">
      {/* Top Banner Skeleton */}
      <div className="bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 dark:from-slate-800 dark:via-slate-850 dark:to-slate-800 rounded-3xl p-5 sm:p-6 space-y-4 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-2">
              ...
              <div className="h-6 w-52 bg-slate-300 dark:bg-slate-700 rounded-lg" />
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
        {[1, 2, 3, 4, 5, 6, 7].map((i) => (
          <div key={i} className="h-9 w-28 shrink-0 bg-slate-200 dark:bg-slate-800 rounded-xl" />
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4.5 rounded-2xl space-y-3 shadow-2xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 flex gap-3">
                <div className="w-16 h-16 bg-slate-200 dark:bg-slate-700 rounded-lg shrink-0" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-3/4 bg-slate-200 dark:bg-slate-700 rounded" />
                  <div className="h-3 w-1/2 bg-slate-200 dark:bg-slate-700 rounded" />
                  <div className="h-4 w-1/3 bg-emerald-100 dark:bg-emerald-950 rounded" />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-5 space-y-4">
          ...
          <div className="h-44 bg-slate-100 dark:bg-slate-800/50 rounded-2xl flex items-center justify-center">
