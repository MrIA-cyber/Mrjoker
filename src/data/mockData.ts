...
export const INITIAL_MERCHANTS: Merchant[] = [
  {
    ...
    isVerified: true,
    logo: '☕',
    shopPhoto: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?auto=format&fit=crop&w=800&q=80',
    avatar: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?auto=format&fit=crop&w=300&q=80',
    views: 1420,
    clicks: 345,
    sales: 0,
  },
  {
    ...
    isVerified: true,
    logo: '👑',
    shopPhoto: 'https://images.unsplash.com/photo-1609357605129-26f69add5d6e?auto=format&fit=crop&w=800&q=80',
  ...
  },
  {
    ...
    isVerified: true,
    logo: '⚡',
    shopPhoto: 'https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=800&q=80',
    avatar: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=300&q=80',
    views: 3100,
    clicks: 680,
    sales: 0,
  },
  {
    ...
    isPremium: false,
    logo: '🌾',
    shopPhoto: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?auto=format&fit=crop&w=800&q=80',
    avatar: 'https://images.unsplash.com/photo-1595855759920-86582396756a?auto=format&fit=crop&w=300&q=80',
    views: 450,
    clicks: 95,
    sales: 0,
  },
  {
    ...
    isPremium: false,
    logo: '🌶️',
    shopPhoto: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80',
    avatar: 'https://images.unsplash.com/photo-1532336414038-cf19250c5757?auto=format&fit=crop&w=300&q=80',
    views: 520,
    clicks: 110,
    sales: 0,
  }
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 4500,
    image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=85',
    category: 'Alimentation & Épicerie',
    merchantId: 'm4',
    merchantName: 'Saveurs Agricoles de Bamendzi',
    isBoosted: false,
